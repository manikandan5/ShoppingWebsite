...
$productID = intval($_POST['productSelected']);
// Connect to server and select databse.
mysql_connect("$host", "$username", "$password")or die("cannot connect");
mysql_select_db("$db_name")or die("cannot select DB");

$sql= "select * from $tbl_name where id=$productID" ;
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="updateP.php" method="post">
                                <div class="col-lg-2">
                                    ProductID
                                </div>
                                <div class="col-lg-3">
                                    <input class="form-control" value="<?php echo $_POST['productSelected'];?>" name="productID" readonly>
                                </div>
                                <br/>
                                <br/>
                                <br/>
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control" value="<?php echo $productName;?>" name="productName">
                                </div>
                                <br/>
                                <br/>
                                <br/>
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control" value="<?php echo $productQty;?>" name="productQty">
                                </div>
                                <br/>
                                <br/>
                                <br/>
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control"  value="<?php echo $productPrice;?>" name="productPrice">
                                </div>
                                <br/>
                                <br/>
                                <br/>
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control"  value="<?php echo $productImg;?>" name="productImg">
                                </div>
                                <br/>
                                <br/>
                                <br/>
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control"  value="<?php echo $productDesc;?>" name="productDesc">
                                </div>
                                <br/>
                                <br/>
                                <br/>
