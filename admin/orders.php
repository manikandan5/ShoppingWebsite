...
<body>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="index.php"><em class="fa fa-dashboard fa-fw text-black"></em><span class="text-black">Dashboard</span></a> </li>
                    <li class="selected">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"> <i class="fa fa-bar-chart-o fa-fw"></i>Order History
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="ordersTables">
                                    <thead>
                                        <tr>
                                            <th>Order ID</th>
                                            <th>Product ID</th>
                                ...
                                <form action="editOrder.php" method="post" style="float: left;">
                                        <input type="hidden" value="" name="orderSelected" id ="orderSelected"></input>
                                        <button type="submit" value="Update" id="updButton">Update</button>
                                </form>
                                <form action="deleteOrder.php" method="post" style="float: left;">
                                        <input type="hidden" value="" name="orderSelected1" id ="orderSelected1"></input>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $( "#ordersTables" ).selectable();
        });
        $("#ordersTables tr").click(function(){
        $(this).addClass('selected-row').siblings().removeClass('selected-row');    
        var value=$(this).find('td:first').html();
        $("#orderSelected").val(value);   
        $("#orderSelected1").val(value);   
        });
