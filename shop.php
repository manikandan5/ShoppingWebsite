...
<body>
	...
	<section>
  		...
  		<div class="container">
  			<div class="row">
  <div class="col-sm-9 padding-right col-md-12">
            ...
            <div class="product-image-wrapper">
              <div class="single-products">
                <div class="productinfo text-center">
                  <img src=<?php echo $row['image'];?> alt="" height="325" width="100"/>
    ...
    <!--<ul text-align="center" class="pagination">
      ...
      <li><a href="">&raquo;</a></li>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
				  <p class="pull-left">Copyright © 2016 RLStores. All rights reserved.</p>
